...
import com.enlighten.transparentproxy.ui.AWSMessageActivity;
...
public class MessageCommandHandler implements HttpRequestHandler {
	...
	public void handle(HttpRequest request, HttpResponse response,
		...
		AppLog.logInfo("Message URI: " + uriString);
		...
		HttpEntity entity = new EntityTemplate(new ContentProducer() {
			public void writeTo(final OutputStream outstream)
				...
				OutputStreamWriter writer = new OutputStreamWriter(outstream,
						"UTF-8");
				String resp = Utility
						.openHTMLString(context, R.raw.messagesend);
	...
	protected void displayMessage(final String message) {
		...
		Notification notification = new Notification(R.drawable.messageicon,
		...
		notification.setLatestEventInfo(context,
				context.getString(R.string.message_title), message, intent);
